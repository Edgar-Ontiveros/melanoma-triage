...
Solo numpy + Pillow; un mapa nulo nunca llega aquí (la API devuelve ``png_base64: null``)."""
...
def overlay_png_base64(crop: np.ndarray, cam: np.ndarray, alpha: float = ALPHA) -> str:
